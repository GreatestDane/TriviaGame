...
var unsorted = document.getElementById("start")
 unsorted.textContent = unsortedArr.toString();

 document.getElementById("go").onclick = function() {
  var mySortedArr = bubbleSort(unsortedArr);
  document.getElementById("result").textContent = mySortedArr;
 };
